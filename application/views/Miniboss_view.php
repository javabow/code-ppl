...
?>
    ...
    <li class="breadcrumb-item text-light active" aria-current="page">Mini Boss</li>
	...
	<div class="col d-flex justify-content-center pt-4">
		<div class="card text-dark" style="width: 18rem; height: 300px;">
	 		<a href="<?php echo base_url(); ?>toram/mini-boss/<?php echo $content->name_id; ?>">
...
<nav aria-label="breadcrumb ">
  ...
  <ol class="breadcrumb arr-right white-text">
    ...
    <li class="breadcrumb-item "><a href="/toram/mini-boss" class="text-light">Mini Boss</a></li>
...
<div class="text-justify">
	<center><img class="" style="width: 300px;" src="https://www.javabow.com/img/<?php echo $content[8];?>" alt="<?php echo $content[2]; ?>"></center>
	<br/>
<br/>
<h2>Boss Info</h2>
...
<div class="row">
<div class="col-md-7">
<form action="<?php echo base_url(); ?>toram/mini-boss/<?php echo $url; ?>#submitted" method="post">
